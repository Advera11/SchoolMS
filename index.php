...
<div class="clearfix m30_auto"></div>
    ...
    <div class="content-bottom-boxes">
    	<img src="imges/academic.jpg" width="300" height="200" />
        <div class="content-bottom-bg">
    ...
    <div class="content-bottom-boxes">
    	<img src="imges/library.jpg" width="300" height="200" />
        <div class="content-bottom-bg">
        	<div class="content-bottom-bg-header">Library</div>
            <div class="content-bottom-bg-p">
            Heritage secondary has a well established school library for supporting learning activities, empowering student so as to be innovators and great competitors as well as increasing knowledge by provision of books, newspapers, and other reading materials to students and staff. 
        	</div>
        </div>
    </div>
